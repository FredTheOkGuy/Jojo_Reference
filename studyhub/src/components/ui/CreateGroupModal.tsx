...
export default function CreateGroupModal({
  ...
  // Real map-searchable location field
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-[#9a9282] font-medium mt-1.5">
              This is just the room/FYI text shown to users. Example: H-561.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-[#9a9282] font-medium mt-1.5">
              This is used for Google Maps. Later, connect this field to Google
              Places autocomplete.
            </p>
          </div>
